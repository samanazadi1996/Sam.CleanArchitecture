...
public class ProductFunctionalTests(CustomWebApplicationFactory<Program> factory) : IClassFixture<CustomWebApplicationFactory<Program>>
{
    ...
    public async Task CreateProduct_ShouldReturnProductId()
    {
        ...
        // Act
        var result = await client.PostAndDeserializeAsync<BaseResult<long>>(url, command, ghostAccount.JwtToken);
    ...
    public async Task UpdateProduct_ShouldSucceed()
    {
        ...
        // Act
        var result = await client.PutAndDeserializeAsync<BaseResult>(url, command, ghostAccount.JwtToken);
    ...
    public async Task DeleteProduct_ShouldSucceed()
    {
        ...
        // Act
        var result = await client.DeleteAndDeserializeAsync<BaseResult>(url, ghostAccount.JwtToken);
